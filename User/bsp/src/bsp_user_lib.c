...
*				V1.4  2020-11-14  增加 char2Hex() Str2Hex()函数
*
*********************************************************************************************************
*/
...
*********************************************************************************************************
*	函 数 名: Char2Hex
*	功能说明: 将字符转换为对应的十六进制数 0-9 a-f A-F
*	形    参: val: 目标字符
*	返 回 值: value:转换得到的十六进制数
*********************************************************************************************************
*/
char Char2Hex(char val)
{
	char value;
	if((val>='0')&&(val<='9')) value=val-'0';
	else if((val>='a')&&(val<='f')) value=val-'a'+10;
	else if((val>='A')&&(val<='F')) value=val-'A'+10;
	return value;
}
...
*********************************************************************************************************
*	函 数 名: Str2Hex
*	功能说明: 将字符数组转换为对应的十六进制数数组 每两个字符一组
*	形    参: str: 目标字符串 
					  result: 结果数组
*	返 回 值: 无
*********************************************************************************************************
*/
void Str2Hex(char *Str, char *result)
{
	char len;
	len=strlen(Str);
	for(int i=0;i<len/2;i++)
	{
		result[i] = Char2Hex(Str[2*i])*16;
		result[i] += Char2Hex(Str[2*i+1]);
	}
}
...
*********************************************************************************************************
*	函 数 名: str_to_int
*	功能说明: 将ASCII码字符串转换成整数。 遇到小数点自动越过。支持负数
